...
####################################################################################################
    ...
    st.image('./TBATS Metric Results.jpg')

    st.subheader("TBATS Model Forecast")
    st.image('./TBATS Forecasting .jpg')

    st.subheader("TBATS Model Forecast vs Actuals")
    st.image('./Actual vs Forecast TBATS.jpg')

    st.subheader("TBATS Errors")
    st.image('./TBATS Error.jpg')

    st.subheader("TBATS Error (train)")
    st.image('./TBATS Error train.jpg')
####################################################################################################
    ...
    st.components.v1.html(
        f'<iframe title="Corrected BI Dashboard" width="980" height="450" src="{power_bi_url}" frameborder="0" allowFullScreen="true"></iframe>',
